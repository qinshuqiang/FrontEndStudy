...
**文本格式化标签：**加粗strong，b， b是加粗，strong加粗兼加强语义，一般使用strong；倾斜em，i，同样道理em要比i强调多一些，用得比较少；删除线s，del；del比s强调多一些；下划线u，ins，使用ins多一些。
...
**锚点定位**：快速的跳页面定位的位置，a href="#suibian"   的a标签回调到id为suibian的标签上
